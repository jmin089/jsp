	...
	<head>
		...
		<style>
			*{margin:0; padding:0;}
			...
			span{display: inline-block; line-height: 30px; width: 30px; height: 30px; border: 1px solid black; text-align: center;}
			span:hover {background: #A390EE; color: white; font-weight: 700;}
		</style>
	</head>
	<body>
		<div>
