...
<body>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        <td><strong>다음글</strong> <span class="separator">|</span><a href="n_view.do?page=${page}&bno=${nextDto.bno}&category=${category}&sword=${sword}">${nextDto.btitle}</a></td>
      </tr>
      <tr>
        <td><strong>이전글</strong> <span class="separator">|</span><a href="n_view.do?page=${page}&bno=${preDto.bno}&category=${category}&sword=${sword}">${preDto.btitle}</a></td>
      </tr>
    </table>
